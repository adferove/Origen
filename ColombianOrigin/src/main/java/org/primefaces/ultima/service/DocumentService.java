...
public class DocumentService {
    ...
    public TreeNode createCheckboxDocuments() {
		...
		TreeNode documents = new CheckboxTreeNode(new Document("Diseño", "-", "Folder"), root);
		TreeNode pictures = new CheckboxTreeNode(new Document("Manejo de clientes", "-", "Folder"), root);
		TreeNode movies = new CheckboxTreeNode(new Document("Directorio", "-", "Folder"), root);
		
		TreeNode work = new CheckboxTreeNode(new Document("Sitio web", "-", "Folder"), documents);
		TreeNode primefaces = new CheckboxTreeNode(new Document("Logo empresarial", "-", "Folder"), documents);
		...
		//Pictures
		TreeNode barca = new CheckboxTreeNode("picture", new Document("Clientes internacionales", "30 KB", "JPEG Image"), pictures);
		TreeNode primelogo = new CheckboxTreeNode("picture", new Document("Intérpretes", "45 KB", "JPEG Image"), pictures);
